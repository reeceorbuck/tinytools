...
export const sseTools = new tiny.Handlers(import.meta.url, {
  imports: [processIncomingDataTools],
}, {
  activateSSE: function (
    ...
    this.sse.onopen = () => {
      console.log("Connected to server, wasConnected: ", this.sse.wasConnected);
