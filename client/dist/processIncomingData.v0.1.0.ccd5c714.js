import { processIncomingHtml } from "./processIncomingHtml.v0.1.0.ccd5c714.js";
...
async function processIncomingData(response, options = {}) {
  ...
  for await (const chunk of response.body) {
    ...
    if (buffer.includes("</update>")) {
      ...
      for (const updateContent of updates) {
        ...
        if (options.cacheCurrentPath || options.activeRoutePath || options.activeRouteRegistrations) {
          options = {
            ...options,
            cacheCurrentPath: void 0,
            activeRoutePath: void 0,
            activeRouteRegistrations: void 0
          };
        }
      }
